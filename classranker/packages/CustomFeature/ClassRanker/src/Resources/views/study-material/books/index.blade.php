<x-admin::layouts>
    <x-slot:title>
        @lang('class_ranker::app.study_materials.books.index.title')
    </x-slot>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-x-2.5">
            <a
                href="{{ route('admin.study_materials.books.create') }}"
                class="primary-button"
            >
                @lang('class_ranker::app.study_materials.books.index.create-btn')
            </a>
        </div>
    </div>

    <x-admin::datagrid :src="route('admin.study_materials.books.index')" :isMultiRow="true">
        <template #header="{
            isLoading,
            available,
            applied,
