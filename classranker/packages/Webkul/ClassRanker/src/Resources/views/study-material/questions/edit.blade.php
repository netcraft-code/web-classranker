<x-admin::layouts>
    ...
    >
        ...
        <!-- VUE COMPONENT -->
        <v-edit-questions></v-edit-questions>
    </x-admin::form>
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                v-model="shortTitle"
                                :value="old('short_title', $question->short_title)"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('top_description', $question->top_description)"
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        >
                            ...
                            <x-admin::form.control-group>
                                ...
                                <textarea
                                    :name="'question_items[' + index + '][question]'"
                                    class="question_text w-full border rounded p-2"
                                    rows="4"
                            ...
                            <x-admin::form.control-group>
                                ...
                                <textarea
                                    :name="'question_items[' + index + '][answer]'"
                                    class="answer_text w-full border rounded p-2"
                                    rows="4"
                                    v-model="item.answer"
                                    required
                                ></textarea>
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('bottom_description', $question->bottom_description)"
                        ...
                        >
                            ...
                            <x-admin::form.control-group>
                                ...
                                <textarea
                                    ...
                                    class="faq_answer w-full border rounded p-2"
                                    rows="3"
                                    v-model="faq.answer"
                                    required
                                ></textarea>
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="related_links"
                                :value="old('related_links', $question->related_links)"
                                label="Related Links"
                                :tinymce="true"
                            />
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            >{{ old('meta_description', $question->meta_description) }}</textarea>
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            ...
                            >{{ old('meta_keywords', $question->meta_keywords) }}</textarea>
                        </x-admin::form.control-group>
                    </div>
                </div>
            ...
            app.component('v-edit-questions', {
                ...
                data() {
                    return {
                        ...
                        // Question items (pre-loaded)
                        questionItems: @json($formattedQuestionItems),

                        // FAQs (pre-loaded)
                        faqs: @json($formattedFaqs),
                    };
                },
