<x-admin::layouts>
    <x-slot:title>
        @lang('class_ranker::app.study_materials.videos.index.title')
    </x-slot>
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                <button type="button" class="primary-button">
                    @lang('class_ranker::app.study_materials.videos.index.create-btn')
                </button>
            </div>
        </div>
    ...
    @pushOnce('scripts')
        <script type="text/x-template" id="v-videos-template">
            ...
            <x-admin::datagrid :src="route('admin.study_materials.videos.index')" :isMultiRow="true">
                <template #header="{
                    isLoading,
                    available,
                    applied,
            ...
            <x-admin::form v-slot="{ meta, errors, handleSubmit }" as="div" ref="modalForm">
                <form @submit="handleSubmit($event, createVideo)" ref="videoForm">
                    <x-admin::modal ref="videoModal" width="max-w-4xl">
                        <x-slot:header>
            ...
            app.component('v-videos', {
                ...
                methods: {
                    ...
                    createVideo(params, { setErrors }) {
                        ...
                        this.$axios.post("{{ route('admin.study_materials.videos.store') }}", formData)
                            .then(response => {
