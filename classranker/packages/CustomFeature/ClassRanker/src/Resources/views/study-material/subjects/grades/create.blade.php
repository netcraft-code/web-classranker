                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group >
                            ...
                            <x-admin::form.control-group.control
                                ...
                                v-model="title"
                                :value="old('title')"
                                :label="trans('class_ranker::app.study_materials.subjects.grades.create.title')"
                                :placeholder="trans('class_ranker::app.study_materials.subjects.grades.create.title')"
                            />
