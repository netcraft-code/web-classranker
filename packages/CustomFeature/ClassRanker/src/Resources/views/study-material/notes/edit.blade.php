<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.study_materials.notes.update', $note->id)">
        @method('PUT')

        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            <p class="text-xl font-bold text-gray-800 dark:text-white">Edit Note</p>
    ...
    @pushOnce('scripts')
    <script type="text/x-template" id="v-edit-notes-template">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            rules="required"
                            v-model="shortTitle"
                            :value="old('short_title', $note->short_title)"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :tinymce="true"
                            :value="old('top_description', $note->top_description)" />
                    </x-admin::form.control-group>
                </div>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :tinymce="true"
                            :value="old('bottom_description', $note->bottom_description)" />
                    </x-admin::form.control-group>
                </div>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            type="text"
                            name="meta_title"
                            :value="old('meta_title', $note->meta_title)"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <textarea name="meta_description" rows="3"
                            class="w-full border rounded p-2 text-sm">{{ old('meta_description', $note->meta_description) }}</textarea>
                    </x-admin::form.control-group>

                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label>Meta Keywords</x-admin::form.control-group.label>
                        <textarea name="meta_keywords" rows="2"
                            class="w-full border rounded p-2 text-sm">{{ old('meta_keywords', $note->meta_keywords) }}</textarea>
                    </x-admin::form.control-group>
                </div>
                    ...
                    <x-slot:content>
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="status"
                                value="1"
                                :checked="(boolean) old('status', $note->status)" />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <input type="checkbox" name="is_premium" value="1"
                                ...
                                {{ old('is_premium', $note->is_premium) ? 'checked' : '' }}>
                        </x-admin::form.control-group>
                    </x-slot>
                </x-admin::accordion>
            </div>
    ...
    <script type="module">
        app.component('v-edit-notes', {
            template: '#v-edit-notes-template',
            ...
            data() {
                return {
                    ...
                    slug:       '{{ old('slug', $note->slug) }}',
                    shortTitle: '{{ old('short_title', $note->short_title) }}',
            ...
            methods: {
                ...
                addAssignment() {
                    ...
                    this.assignments.push({
                        ...
                        boardName: board.name, gradeName: grade.name,
                        subjectName: subject.name, bookName: book.title,
