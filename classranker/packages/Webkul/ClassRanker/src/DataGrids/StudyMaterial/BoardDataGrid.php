...
class BoardDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index'      => 'id',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.id'),
            'type'       => 'integer',
            'searchable' => true,
            'filterable' => true,
            'sortable'   => true,
        ...
        $this->addColumn([
            'index'      => 'name',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.name'),
            'type'       => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable'   => true,
        ...
        $this->addColumn([
            'index'      => 'code',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.code'),
            'type'       => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable'   => true,
        ...
        $this->addColumn([
            'index'      => 'is_premium',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.is-premium'),
            'type'       => 'boolean',
            'filterable' => true,
            'filterable_options' => [
                [
        ...
        $this->addColumn([
            'index'      => 'avatar',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.avatar'),
            'type'       => 'string',
        ...
        $this->addColumn([
            'index'      => 'status',
            'label'      => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.status'),
            'type'       => 'boolean',
            'filterable' => true,
            'filterable_options' => [
                [
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon'   => 'icon-edit',
            'title'  => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.edit'),
            'method' => 'GET',
            'url'    => function ($row) {
        ...
        $this->addAction([
            'icon'   => 'icon-delete',
            'title'  => trans('class_ranker::app.study_materials.subjects.boards.index.datagrid.delete'),
            'method' => 'DELETE',
            'url'    => function ($row) {
