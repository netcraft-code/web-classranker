...
use Webkul\ClassRanker\Http\Controllers\StudyMaterial\SubjectController;
use Webkul\ClassRanker\Http\Controllers\StudyMaterial\GradeController;
...
use Webkul\ClassRanker\Http\Controllers\StudyMaterial\QuizController;
