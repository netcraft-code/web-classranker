<x-admin::layouts>
    ...
    <script type="text/x-template" id="v-quizzes-template">
        ...
        <x-admin::datagrid :src="route('admin.study_materials.quizzes.index')" :isMultiRow="true">
            <template #header="{
                isLoading,
                available,
                applied,
                ...
                <template v-else>
                    ...
                    >
                        <div
                            ...
                            v-for="(columnGroup, index) in [['id', 'created_at', 'status', 'is_premium'], ['slug', 'title'], ['board_name', 'grade_name', 'subject_name', 'book_title', 'chapter_title'], ['question_count']]"
                        >
