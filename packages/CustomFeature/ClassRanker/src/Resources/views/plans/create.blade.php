<x-admin::layouts>
    <x-slot:title>
        @lang('class_ranker::app.plans.create.title')
    </x-slot>
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                <button type="submit" class="primary-button">
                    @lang('class_ranker::app.plans.create.save-btn')
                </button>
            </div>
        </div>

        <v-create-plan></v-create-plan>
    </x-admin::form>

    @pushOnce('scripts')
        <!-- ================= TEMPLATE ================= -->
        <script type="text/x-template" id="v-create-plan-template">
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :value="old('price')"
                                    step="0.01"
                                    :label="trans('class_ranker::app.plans.create.price')"
                                    placeholder="0.00"
                                />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    step="0.01"
                                    :label="trans('class_ranker::app.plans.create.discount-price')"
                                    placeholder="0.00"
                                />
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('class_ranker::app.plans.create.duration-value')"
                                    placeholder="1"
                                />
                        ...
                        <!-- Duration label preview -->
                        <p
                            v-if="durationValue && durationType"
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('class_ranker::app.plans.create.sort-order')"
                                    placeholder="0"
                                />
                    ...
                    <x-admin::accordion>
                        ...
                        <x-slot:content>
                            <div
                                style="border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px; text-align: center; position: relative; overflow: hidden;"
                            >
                                <!-- Popular badge -->
                                <div
                                    v-if="isPopular"
        ...
        <!-- ================= SCRIPT ================= -->
        <script type="module">
            app.component('v-create-plan', {
                template: '#v-create-plan-template',
                ...
                methods: {
                    ...
                    addFeature() {
                        this.features.push('');
                        this.$nextTick(() => {
                            const inputs = this.$el.querySelectorAll('[name^="features"]');
