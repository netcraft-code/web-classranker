...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('class_ranker::app.study_materials.subjects.subjects.index.title'); ?>
     <?php $__env->endSlot(); ?>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-x-2.5">
            <a
                href="<?php echo e(route('admin.study_materials.subjects.subjects.create')); ?>"
                class="primary-button"
            >
                <?php echo app('translator')->get('class_ranker::app.study_materials.subjects.subjects.index.create-btn'); ?>
            </a>
        </div>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.datagrid.index','data' => ['src' => route('admin.study_materials.subjects.subjects.index'),'isMultiRow' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.study_materials.subjects.subjects.index')),'isMultiRow' => true]); ?>
        <template #header="{
            isLoading,
            available,
            applied,
            ...
            <template v-else>
                ...
                >
                    <div
                        ...
                        v-for="(columnGroup, index) in [['id', 'created_at', 'status'], ['avatar', 'code', 'name'], ['board_code', 'board_name', 'board_title'], ['grade_code', 'grade_name', 'grade_title']]"
                    >
...
<?php endif; ?>
<?php /**PATH /home/anmol/www/html/Customization/Abhishek/web-classranker/classranker/packages/CustomFeature/ClassRanker/src/Providers/../Resources/views/study-material/subjects/subjects/index.blade.php ENDPATH**/ ?>