...
namespace CustomFeature\ClassRankerApi\Http\Controllers\V1\Shop;

use Illuminate\Http\Request;
use CustomFeature\ClassRankerApi\Contracts\ResourceContract;
use CustomFeature\ClassRankerApi\Http\Controllers\V1\V1Controller;
use CustomFeature\ClassRankerApi\Traits\ProvideResource;
use CustomFeature\ClassRankerApi\Traits\ProvideUser;
