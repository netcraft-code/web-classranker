<x-admin::layouts>
    ...
    >
        ...
        <v-edit-notification
            :initial-notification='@json($notification)'
        ></v-edit-notification>
    </x-admin::form>
    ...
    @pushOnce('scripts')
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <x-admin::media.images
                                    ...
                                    :uploaded-images="$notification->image
                                        ? [['id' => 'existing-image', 'url' => asset('storage/' . $notification->image)]]
                                        : []"
                                />
                            </div>
                        </x-slot>
        ...
        <script type="module">
            app.component('v-edit-notification', {
                ...
                data() {
                    return {
                        title: this.initialNotification.title || '',

                        text: this.initialNotification.text || '',

                        redirectType:
                            this.initialNotification.redirect_type || 'internal',

                        link:
                            this.initialNotification.link || '',

                        path:
                            this.initialNotification.path || '',

                        params: this.initialNotification.params
                            ? JSON.stringify(
                                this.initialNotification.params,
                                null,
                                4
                            )
                            : '{}',
