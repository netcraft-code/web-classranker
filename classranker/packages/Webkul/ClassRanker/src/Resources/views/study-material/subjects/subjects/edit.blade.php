<x-admin::layouts>
    <!--Page title -->
    <x-slot:title>
        @lang('class_ranker::app.study_materials.subjects.subjects.edit.title')
    </x-slot>

    <!--Edit Page Form -->
    <x-admin::form
        :action="route('admin.study_materials.subjects.subjects.update', $subject->id)"
        method="PUT"
    ...
    >
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('class_ranker::app.study_materials.subjects.subjects.edit.update-btn')
                </button>
            </div>
        </div>

        <!-- VUE COMPONENT -->
        <v-edit-subjects></v-edit-subjects>
    </x-admin::form>

    @pushOnce('scripts')
        <!-- ================= TEMPLATE ================= -->
        <script type="text/x-template" id="v-edit-subjects-template">
            <!-- body content -->
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('class_ranker::app.study_materials.subjects.subjects.edit.information')
                        </p>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('class_ranker::app.study_materials.subjects.subjects.edit.name')
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :label="trans('class_ranker::app.study_materials.subjects.subjects.edit.name')"
                                :placeholder="trans('class_ranker::app.study_materials.subjects.subjects.edit.name')"
                            />
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('class_ranker::app.study_materials.subjects.subjects.edit.code')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :label="trans('class_ranker::app.study_materials.subjects.subjects.edit.code')"
                                :placeholder="trans('class_ranker::app.study_materials.subjects.subjects.edit.code')"
                            />
                    ...
                    <x-admin::accordion>
                        <x-slot:header>
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('class_ranker::app.study_materials.subjects.subjects.edit.settings')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('class_ranker::app.study_materials.subjects.subjects.edit.status')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="status"
                                    value="1"
                                    :label="trans('class_ranker::app.study_materials.subjects.subjects.edit.status')"
                                    :checked="(boolean) old('status', $subject->status)"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('class_ranker::app.study_materials.subjects.subjects.edit.is-premium')
                                </x-admin::form.control-group.label>
                            ...
                            <div class="flex w-2/5 flex-col gap-2">
                                <p class="font-medium text-gray-800 dark:text-white">
                                    @lang('class_ranker::app.study_materials.subjects.subjects.edit.avatar')
                                </p>

                                <p class="text-xs text-gray-500">
                                    @lang('class_ranker::app.study_materials.subjects.subjects.edit.avatar-size')
                                </p>

                                <x-admin::media.images 
                                    name="avatar"
                                    :uploaded-images="$subject->avatar ? [['id' => 'avatar', 'url' => $subject->avatar_url]] : []"
                                />
                            </div>
                        </x-slot>
                    </x-admin::accordion>
        ...
        <!-- ================= SCRIPT ================= -->
        <script type="module">
            app.component('v-edit-subjects', {
                template: '#v-edit-subjects-template',

                data() {
                    return {
                        // Board and Grade from relationships
                        board: @json($subject->board),
                        grade: @json($subject->grade),

                        // Subject data
                        name: '{{ old('name', $subject->name) }}',
                        code: '{{ old('code', $subject->code) }}',
                        
                        subjectIsPremium: {{ old('is_premium', $subject->is_premium) ? 'true' : 'false' }},
                        isPremiumLocked: false,
                    };
                },

                mounted() {
                    // Check if grade is premium on load
                    if (this.grade && this.grade.is_premium) {
